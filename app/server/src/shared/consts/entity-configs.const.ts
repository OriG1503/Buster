...
export const BATTERY_CONFIG = {
  ...
  columns: {
    ...
    batteryVersion: {
      label: 'גרסת סוללה',
      csvHeader: 'גרסת סוללה',
      parserFieldName: 'battery_version',
      valueType: 'string',
    },
    lithiumVersion: {
      label: 'גרסת ליתיום',
      csvHeader: 'גרסת ליתיום',
      parserFieldName: 'lithium_version',
      valueType: 'string',
    },
    ...
    isStockTelAviv: {
      label: 'מלאי תל אביב סוללה',
      csvHeader: 'מלאי תל אביב סוללה',
      parserFieldName: 'battery_is_stock_tel_aviv',
      valueType: 'bool',
    },
    isStockRehovot: {
      label: 'מלאי רחובות סוללה',
      csvHeader: 'מלאי רחובות סוללה',
      parserFieldName: 'battery_is_stock_rehovot',
      valueType: 'bool',
    },
...
export const CARDBOARD_CONFIG = {
  ...
  columns: {
    ...
    cardboardType: {
      label: 'סוג קרטון',
      csvHeader: 'סוג קרטון',
      parserFieldName: 'cardboard_type',
      valueType: 'string',
    },
    cardboardVersion: {
      label: 'גרסת קרטון',
      csvHeader: 'גרסת קרטון',
      parserFieldName: 'cardboard_version',
      valueType: 'string',
    },
    notes: { label: 'הערה', csvHeader: 'הערה', parserFieldName: 'notes', valueType: 'meta' },
    source: { label: 'מ"ד', csvHeader: 'מ"ד', parserFieldName: 'source', valueType: 'meta' },
...
export const COMMUNICATION_CONFIG = {
  ...
  columns: {
    ...
    communicationType: {
      label: 'סוג תקשורת',
      csvHeader: 'סוג תקשורת',
      parserFieldName: 'communication_type',
      valueType: 'string',
    },
    notes: { label: 'הערה', csvHeader: 'הערה', parserFieldName: 'notes', valueType: 'meta' },
    source: { label: 'מ"ד', csvHeader: 'מ"ד', parserFieldName: 'source', valueType: 'meta' },
...
export const IRON_CONFIG = {
  ...
  columns: {
    ...
    heatConductor: {
      label: 'מוליך חום',
      csvHeader: 'מוליך חום',
      parserFieldName: 'heat_conductor',
      valueType: 'string',
    },
    isStockAshdod: {
      label: 'מלאי אשדוד ברזל',
      csvHeader: 'מלאי אשדוד ברזל',
      parserFieldName: 'iron_is_stock_ashdod',
      valueType: 'bool',
    },
    notes: { label: 'הערה', csvHeader: 'הערה', parserFieldName: 'notes', valueType: 'meta' },
    source: { label: 'מ"ד', csvHeader: 'מ"ד', parserFieldName: 'source', valueType: 'meta' },
...
export const ROBOT_CONFIG = {
  ...
  columns: {
    ...
    communicationId: {
      label: 'מזהה תקשורת',
      csvHeader: 'מזהה תקשורת',
      parserFieldName: 'communication_UUID',
      valueType: 'fk',
    },
    ...
    storeName: {
      label: 'שם חנות רובוט',
      csvHeader: 'שם חנות רובוט',
      parserFieldName: 'robot_store_name',
      valueType: 'string',
    },
    isPurchased: { label: 'נרכש', csvHeader: 'נרכש', parserFieldName: 'is_purchased', valueType: 'bool' },
    isStockAshdod: {
      label: 'מלאי אשדוד רובוט',
      csvHeader: 'מלאי אשדוד רובוט',
      parserFieldName: 'robot_is_stock_ashdod',
      valueType: 'bool',
    },
    isStockTelAviv: {
      label: 'מלאי תל אביב רובוט',
      csvHeader: 'מלאי תל אביב רובוט',
      parserFieldName: 'robot_is_stock_tel_aviv',
      valueType: 'bool',
    },
    isStockRehovot: {
      label: 'מלאי רחובות רובוט',
      csvHeader: 'מלאי רחובות רובוט',
      parserFieldName: 'robot_is_stock_rehovot',
      valueType: 'bool',
    },
    isStockNetanya: {
      label: 'מלאי נתניה רובוט',
      csvHeader: 'מלאי נתניה רובוט',
      parserFieldName: 'robot_is_stock_netanya',
      valueType: 'bool',
    },
    isStockAfula: {
      label: 'מלאי עפולה רובוט',
      csvHeader: 'מלאי עפולה רובוט',
      parserFieldName: 'robot_is_stock_afula',
      valueType: 'bool',
    },
    notes: { label: 'הערה', csvHeader: 'הערה', parserFieldName: 'notes', valueType: 'meta' },
    source: { label: 'מ"ד', csvHeader: 'מ"ד', parserFieldName: 'source', valueType: 'meta' },
...
export const SENSOR_CONFIG = {
  ...
  columns: {
    ...
    sensorVersion: {
      label: 'גרסת חיישן',
      csvHeader: 'גרסת חיישן',
      parserFieldName: 'sensor_version',
      valueType: 'string',
    },
    notes: { label: 'הערה', csvHeader: 'הערה', parserFieldName: 'notes', valueType: 'meta' },
    source: { label: 'מ"ד', csvHeader: 'מ"ד', parserFieldName: 'source', valueType: 'meta' },
...
export const STORAGE_CONFIG = {
  ...
  columns: {
    ...
    storageVersion: {
      label: 'גרסת אחסון',
      csvHeader: 'גרסת אחסון',
      parserFieldName: 'storage_version',
      valueType: 'string',
    },
    isStockNetanya: {
      label: 'מלאי נתניה אחסון',
      csvHeader: 'מלאי נתניה אחסון',
      parserFieldName: 'storage_is_stock_netanya',
      valueType: 'bool',
    },
    isStockAfula: {
      label: 'מלאי עפולה אחסון',
      csvHeader: 'מלאי עפולה אחסון',
      parserFieldName: 'storage_is_stock_afula',
      valueType: 'bool',
    },
    notes: { label: 'הערה', csvHeader: 'הערה', parserFieldName: 'notes', valueType: 'meta' },
    source: { label: 'מ"ד', csvHeader: 'מ"ד', parserFieldName: 'source', valueType: 'meta' },
...
export const WIRING_CONFIG = {
  ...
  columns: {
    ...
    storeName: {
      label: 'שם חנות חיווט',
      csvHeader: 'שם חנות חיווט',
      parserFieldName: 'wiring_store_name',
      valueType: 'string',
    },
    notes: { label: 'הערה', csvHeader: 'הערה', parserFieldName: 'notes', valueType: 'meta' },
    source: { label: 'מ"ד', csvHeader: 'מ"ד', parserFieldName: 'source', valueType: 'meta' },
