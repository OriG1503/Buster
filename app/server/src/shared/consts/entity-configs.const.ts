...
export const BATTERY_CONFIG = {
  ...
  columns: {
    ...
    isStockTelAviv: { label: 'מלאי תל אביב',  csvHeader: 'מלאי תל אביב סוללה',  parserFieldName: 'battery_is_stock_tel_aviv', valueType: 'bool'   },
...
export const ROBOT_CONFIG = {
  ...
  columns: {
    ...
    district:        { label: 'מחוז',          csvHeader: 'מחוז רובוט',           parserFieldName: 'robot_district',          valueType: 'string' },
    storeName:       { label: 'שם חנות',       csvHeader: 'שם חנות רובוט',        parserFieldName: 'robot_store_name',        valueType: 'string' },
    isPurchased:     { label: 'נרכש',          csvHeader: 'נרכש',                 parserFieldName: 'is_purchased',            valueType: 'bool'   },
    isStockAshdod:   { label: 'מלאי אשדוד',   csvHeader: 'מלאי אשדוד רובוט',    parserFieldName: 'robot_is_stock_ashdod',   valueType: 'bool'   },
    isStockTelAviv:  { label: 'מלאי תל אביב', csvHeader: 'מלאי תל אביב רובוט',  parserFieldName: 'robot_is_stock_tel_aviv',  valueType: 'bool'   },
    isStockRehovot:  { label: 'מלאי רחובות',  csvHeader: 'מלאי רחובות רובוט',   parserFieldName: 'robot_is_stock_rehovot',  valueType: 'bool'   },
    isStockNetanya:  { label: 'מלאי נתניה',   csvHeader: 'מלאי נתניה רובוט',    parserFieldName: 'robot_is_stock_netanya',  valueType: 'bool'   },
...
export const STORAGE_CONFIG = {
  ...
  columns: {
    ...
    isStockNetanya: { label: 'מלאי נתניה', csvHeader: 'מלאי נתניה אחסון',   parserFieldName: 'storage_is_stock_netanya', valueType: 'bool'   },
