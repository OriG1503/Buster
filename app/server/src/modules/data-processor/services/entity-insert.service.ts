...
export class EntityInsertService {
  public constructor(private readonly _fkConflictService: FkConflictService) {}
  ...
  public buildMissingIdResult(tableName: string, rowIndex: number, record: Record<string, EntityValue>): EntityResult {
    ...
    return {
      count: 0, conflictIds: [],
      flyingField: { entity: tableName, rowIndex, redFields: dataFields, yellowFields: [], isUuidRed: false } as FlyingField,
