...
export const ENTITY_COLUMN_TREE: Record<string, ColumnGroupStructure[]> = {
  ...
  sensors:        [SENSOR_GROUP, ROBOT_GROUP, CARDBOARD_GROUP, COMMUNICATION_GROUP, PLASTIC_GROUP, BATTERY_GROUP, IRON_GROUP, WIRING_GROUP, STORAGE_GROUP],
  cardboards:     [CARDBOARD_GROUP, ROBOT_GROUP, SENSOR_GROUP, COMMUNICATION_GROUP, PLASTIC_GROUP, BATTERY_GROUP, IRON_GROUP, WIRING_GROUP, STORAGE_GROUP],
  wirings:        [WIRING_GROUP, STORAGE_GROUP, ROBOT_GROUP, CARDBOARD_GROUP, SENSOR_GROUP, COMMUNICATION_GROUP, PLASTIC_GROUP, BATTERY_GROUP, IRON_GROUP],
  storages:       [STORAGE_GROUP, WIRING_GROUP, ROBOT_GROUP, CARDBOARD_GROUP, SENSOR_GROUP, COMMUNICATION_GROUP, PLASTIC_GROUP, BATTERY_GROUP, IRON_GROUP],
  communications: [COMMUNICATION_GROUP, PLASTIC_GROUP, IRON_GROUP, BATTERY_GROUP, ROBOT_GROUP, CARDBOARD_GROUP, SENSOR_GROUP, WIRING_GROUP, STORAGE_GROUP],
  plastics:       [PLASTIC_GROUP, BATTERY_GROUP, COMMUNICATION_GROUP, IRON_GROUP, ROBOT_GROUP, CARDBOARD_GROUP, SENSOR_GROUP, WIRING_GROUP, STORAGE_GROUP],
  batteries:      [BATTERY_GROUP, PLASTIC_GROUP, COMMUNICATION_GROUP, IRON_GROUP, ROBOT_GROUP, CARDBOARD_GROUP, SENSOR_GROUP, WIRING_GROUP, STORAGE_GROUP],
  irons:          [IRON_GROUP, COMMUNICATION_GROUP, PLASTIC_GROUP, BATTERY_GROUP, ROBOT_GROUP, CARDBOARD_GROUP, SENSOR_GROUP, WIRING_GROUP, STORAGE_GROUP],
};
